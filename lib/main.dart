...
class _IncidentReportScreenState extends State<IncidentReportScreen> {
  ...
  Future<void> sendReportToBackend(String userInput, String location, String time, String date) async {
    final url = Uri.parse('http://192.168.131.199:5000/generate-report'); // Replace with the correct URL if needed
    ...
    if (response.statusCode == 200) {
      ...
      final generatedReport = responseData['generated_report'];
      setState(() {
        _generatedReport = generatedReport;
      });
    } else {
      setState(() {
        _generatedReport = "Failed to generate report: ${response.statusCode}";
      });
    }
  }
  ...
  void _generateReport() {
    ...
    sendReportToBackend(description, location, time, date);
  }
